...
class TestCV2FindImage(unittest.TestCase):
    ...
    def test_output_image_draw_point(self, mock_imwrite, mock_imread):
        logger = self.get_test_logger()
        mock_imread.return_value = MagicMock()
        result = output_image_draw_point(logger, 'image_path', (50, 50))
        mock_imwrite.assert_called_once()
        self.assertIn('result_output_image_draw_point.png', result)
